export default {
  ...
  'user-login.login.tab-login-qrcode': '钉钉扫码登录',
  ...
  'user-login.employee.account': '员工账号',
  'user-login.login.method.account': '帐号密码登录',
  'user-login.login.method.mobile': '手机号登录',
  'user-login.login.method.qrcode': '钉钉扫码登录'
};
