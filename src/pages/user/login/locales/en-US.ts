export default {
  ...
  'user-login.employee.account': 'employees account',
  'user-login.login.method.account': 'By Account',
  'user-login.login.method.mobile': 'By Mobile',
  'user-login.login.method.qrcode': 'By Qrcode'
};
